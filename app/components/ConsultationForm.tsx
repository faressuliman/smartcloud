    ...
    >
      <div className="mb-4 sm:mb-6">
        <div className="mb-2 flex flex-wrap items-center gap-2 sm:gap-3">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-slate-900">Request Consultation</h2>
          <ArrowDownRight className="h-5 w-5 sm:h-6 sm:w-6 md:h-8 md:w-8 text-primary" />
        </div>
        <p className="text-xs sm:text-sm md:text-base text-slate-600">
          Get in touch with our expert team to discuss your technology needs. We&apos;re here to provide
          tailored solutions for your smart automation, ELV systems, and marine technical supplies.
        </p>
      </div>
      {isSuccess ? (
        <motion.div
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid gap-6 sm:grid-cols-2">
            <div>
              <input
                ...
                className="w-full border-2 border-secondary/30 bg-white px-4 py-3 text-slate-900 transition-all duration-150 focus:border-primary focus:outline-none placeholder:text-xs sm:placeholder:text-base placeholder:text-slate-400"
          ...
          <div>
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                className="w-full border-2 border-secondary/30 bg-white pl-4 pr-10 py-3 text-slate-900 transition-all duration-150 focus:border-primary focus:outline-none appearance-none cursor-pointer text-xs sm:text-base"
              >
                <option value="">Select a service</option>
                <option value="smart-automation">Smart Automation</option>
                <option value="elv-systems">ELV Systems</option>
                <option value="marine-supplies">Marine Technical Supplies</option>
          ...
          <div>
            <textarea
              ...
              onChange={handleChange}
              rows={5}
              className="w-full border-2 border-secondary/30 bg-white px-4 py-3 text-slate-900 transition-all duration-300 delay-75 focus:border-primary focus:outline-none placeholder:text-xs sm:placeholder:text-base placeholder:text-slate-400"
          ...
          <motion.button
            ...
            className="w-full rounded-lg bg-linear-to-r from-primary to-primary-dark px-6 py-4 font-semibold text-white transition-all hover:shadow-lg disabled:cursor-not-allowed disabled:hover:bg-linear-to-r disabled:hover:from-primary disabled:hover:to-primary-dark cursor-pointer flex items-center justify-center"
