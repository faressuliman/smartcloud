...
const WhatsAppButton = memo(function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed left-4 z-9999 flex h-12 w-12 items-center justify-center rounded-full bg-linear-to-r from-green-500 to-green-600 shadow-lg transition-all hover:shadow-xl sm:left-6 sm:h-14 sm:w-14 cursor-pointer"
      style={{
